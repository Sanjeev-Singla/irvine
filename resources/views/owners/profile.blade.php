        ...
        <form>
            <div class="newagent-profile-row1 agent-profile-row1 agent-profile-row11">
                ...
                <div class="tenbox11 imgtenbox12">
                    <img src="assets/img/about.jpg" alt="profile-img">
                </div>
            </div>
            <div class="newagent-profile-row1 agent-profile-row1 agent-profile-row11">

                <div class="editbtn tenboxeditbtn"><a href="{{ route('update-owner-profile') }}" class="btn btn-secondary rounded-pill">Edit</a></div>
